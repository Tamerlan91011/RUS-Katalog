...
// Виджет корзины для планшетов
class TabletCart extends StatefulWidget {
  const TabletCart({Key? key}) : super(key: key);

  @override
  _TabletCartState createState() => _TabletCartState();
}

class _TabletCartState extends State<TabletCart> {
  String query = "";
