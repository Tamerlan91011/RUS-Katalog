...
class TabletProduct extends StatefulWidget {
  const TabletProduct(
      {Key? key,
  ...
  @override
  State<TabletProduct> createState() => _TabletProductState();
}

class _TabletProductState extends State<TabletProduct> {
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: SingleChildScrollView(
          ...
          Text("Код товара: ${widget.product.itemNumber}",
          ...
          Row(
            ...
            children: [
              Visibility(
                visible:
                    MediaQuery.of(context).size.width > mobileWidth + 200.0,
                child: Expanded(
                  flex: 1,
                  child: Card(
                      child: Padding(
    ...
    for (var element in widget.feedbackList) {
      feedbacks.add(Column(
        ...
        children: [
          ...
          Row(
            children: [
              Text(element.clientName, maxLines: 3,
