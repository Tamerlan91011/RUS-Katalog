...
class MakeOrderMobile extends StatefulWidget {
  const MakeOrderMobile({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                      onPressed: () async {
                        if (addAddress) {
                          if (cityController.text.toString().isNotEmpty &&
                              streetController.text.toString().isNotEmpty &&
                              houseController.text.toString().isNotEmpty &&
                              flatController.text.toString().isNotEmpty) {
                            addresses.add(Address(
                                ...
                                flat:
                                    int.parse(flatController.text.toString())));
                          } else {
                        ...
                        String? token = await LocalData.getUser();
                        Address address = currentAddress != "Добавить"
                            ? addresses.firstWhere((element) =>
                                element.toString() == currentAddress)
                            : addresses.last;
